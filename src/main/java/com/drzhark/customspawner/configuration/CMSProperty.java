...
package com.drzhark.customspawner.configuration;
...
public class CMSProperty {
    ...
    public CMSProperty(String name, String value, Type type) {
        this(name, value, type, false);
    }

    public CMSProperty(String name, String value, Type type, String comment) {
        this(name, value, type, false);
        this.comment = comment;
    }

    CMSProperty(String name, String value, Type type, boolean read) {
        setName(name);
        this.value = value;
        this.type = type;
        this.wasRead = read;
    ...
    public CMSProperty(String name, List<String> values, Type type) {
        this(name, values, type, false);
    }

    public CMSProperty(String name, List<String> values, Type type, String comment) {
        this(name, values, type, false);
        this.comment = comment;
    }

    CMSProperty(String name, List<String> values, Type type, boolean read) {
        setName(name);
        this.type = type;
    ...
    /**
     * Checks if the current value stored in this CMSProperty can be converted
     * to an integer.
     *
    ...
    /**
     * Checks if all of the current values stored in this property can be
     ...
     * determine if the ID returned is a configured one, or a automatically
     * generated one.
     *
